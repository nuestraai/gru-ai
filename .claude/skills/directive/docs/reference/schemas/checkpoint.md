...
- `projects[]` — array of {id, status} referencing project.json files
...
**DOD Verification:** Written by the review phase into `project.json tasks[].dod[].met`. The review-gate checks this via `validate-reviews.sh`.
